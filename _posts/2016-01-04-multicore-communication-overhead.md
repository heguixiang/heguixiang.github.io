...
3.07年一篇合肥工业大学的硕士论文[《对称多核处理器中cache一致性的研究与实现》](http://heguixiang.github.io/paper/对称多核处理器Cache一致性的研究与实现.caj)的摘要第一段有这么样一句话：**在此基础上引出了数据一致性问题，数据高速缓存的一致性(cache coherence)是解决多核之间通信的一个重要课题**
